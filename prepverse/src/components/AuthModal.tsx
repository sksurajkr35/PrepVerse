...
export const AuthModal: React.FC<{ isOpen: boolean; onClose: () => void; initialMode?: 'login' | 'signup' }> = ({
  ...
  const { setUser, loginWithGoogle, loginDemoUser } = useApp();
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-2 pt-1">
                <button
                  ...
                  disabled={loading}
                  className="w-full py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700/80 border border-slate-700 text-xs font-medium text-slate-200 flex items-center justify-center gap-2 transition-colors cursor-pointer"
                >
